...
PRINCIPAL:
	LDI MSK,0b00000001	//inicializa máscara de bits (bit0=1)
	LDI AUX,0b00000000	//inicializa registrador (todos acessos)
...
CRESCENTE:
	...
	SBIS PORTD,7		//pula próxima instrução se o bit 7 do PORTD estiver em 1 (LED apagado)
